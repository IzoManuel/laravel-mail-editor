...
class MailablesController extends Controller
{
    ...
    public function index()
    {
        ...
        //return view('backend.manage_mailables.mailables.index', compact('mailables'));
    }
    ...
    public function viewMailable($name)
    {
        ...
        //return view('backend.manage_mailables.mailables.view')->with(compact('resource'));
    }
    ...
    public function editMailable($name)
    {
        ...
        //return view('backend.manage_mailables.mailables.edit',  compact('templateData', 'name'));
    }
